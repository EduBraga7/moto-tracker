            ...
            {process.env.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY ? (
              <div className="space-y-2">
                <SignInButton mode="modal">
                  <Button
                    type="button"
                    className="w-full h-9 text-xs font-semibold gap-2 bg-gradient-to-r from-red-600 to-rose-600 text-white hover:from-red-700 hover:to-rose-700 cursor-pointer shadow-sm"
                  >
                    <Zap className="h-4 w-4" />
                    <span>Entrar com Google / GitHub (Clerk)</span>
                  </Button>
                </SignInButton>
              </div>
            ) : (
